...
class _InfoModalContent extends StatelessWidget {
  ...
  Widget _buildComoJugar(bool small) {
    final items = [
      ...
      },
      {
        ...
        'text':
            'Elige si deseas jugar con comodines (puedes elegir algunos o todos).',
      },
      {
      ...
      },
      {
        ...
        'text': 'Los demás jugadores pueden validar si tu palabra es correcta.',
      },
      {
      ...
      },
      {
        ...
        'text':
            'Si no respondes a tiempo, pierdes tu turno (o la partida en modo Difícil).',
      },
    ];
  ...
  Widget _buildReglas(bool small) {
    final items = [
      {
        'icon': Icons.login,
        'text': 'Cada jugador debe registrarse con un nombre.',
      },
      {
        'icon': Icons.category,
        'text': 'Debes elegir una categoría (predefinida o creada).',
      },
      {
        'icon': Icons.abc_rounded,
        'text': 'Solo se selecciona una letra por turno.',
      },
      {
      ...
      },
      {
        ...
        'text': 'Tiempo de respuesta: 10s Fácil — 5s Difícil — 5s Grupal.',
      },
      {
      ...
      },
      {
        ...
        'text': 'Los jugadores pueden validar si la palabra es válida.',
      },
      {
